...
using Biu.Projects.Cores.Middleware;
using Biu.Projects.Cores.Middleware.Extentions;
using Biu.Projects.Cores.Proxy.Options;
using System;
using System.Collections.Generic;
using Biu.Projects.Cores.DynamicMiddleware;

namespace Biu.Projects.Cores.Proxy.Extentions
{
    /// <summary>
